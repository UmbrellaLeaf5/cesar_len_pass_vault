...
class CesarVaultApp(App):
  ...
  # Мастер-пароль хранится в памяти открытым текстом на время сессии.
  # Это необходимо для шифрования/дешифрования vault при каждом upload/download.
  # Очищается в on_enter UnlockScreen при следующем запуске.
  master_password: str = ""
